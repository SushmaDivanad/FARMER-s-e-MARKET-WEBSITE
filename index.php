    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Formers E-Narket.<br>
            Navanagar, Bagalkot
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:7892899881">7892899881</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:cviraktamath@gmail.com" class="email__addr">cviraktamath@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Formers E-Market;
          </div>
